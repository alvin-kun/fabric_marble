...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	...
	if len(args) == 1 {
		...
		if len(args[0]) == 0 {
			...
			fmt.Println(" Great news every, arg[0] is not empty")
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	fmt.Println(" ")
	fmt.Print("starting invoke, for - " + function)
	...
	} else if function == "read_everything" { //read everything, (owner + marble + companies)
